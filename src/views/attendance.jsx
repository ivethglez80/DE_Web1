...
const Attendance = () =>{
    ...
    return(
        ...
        <p className="font-julius text-center text-xs pb-6 w-3/4 pt-8 md:text-2xl md:w-1/3 md:pb-16">Por favor considera las especificaciones que hemos provisto para que este dia sea memorable para todos, gracias!</p>      
